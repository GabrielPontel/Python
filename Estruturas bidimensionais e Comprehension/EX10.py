...
estados = list(set(estado for estado, _ in funcionarios))

lista_de_listas = [[qtd for uf, qtd in funcionarios if uf == estado]for estado in estados]

dicionario_listas ={estado: [qtd for uf, qtd in funcionarios if uf == estado] for estado in estados}
